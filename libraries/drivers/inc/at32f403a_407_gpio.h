...
#define EXT_SPIM_EN                      EXT_SPIM_GMUX_1000 /*!< enable external spi-flash interface */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t tmr5ch4_int_mux      : 1; /* [16] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t ext_spim_en          : 1; /* [21] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t mii_rmii_sel         : 1; /* [18] */

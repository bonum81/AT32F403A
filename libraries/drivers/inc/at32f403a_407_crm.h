...
typedef enum
{
  CRM_HICK_SCLK_FIXED_8MHZ               = 0x00, /*!< fixed 8 mhz when hick is selected as sclk */
  CRM_HICK_SCLK_48MHZ_8MHZ               = 0x01  /*!< 8 mhz or 48 mhz depend on hickdiv when hick is selected as sclk */
...
void crm_hick_div6_set(crm_hick_div_6_type value);

...
/** @defgroup EMAC_phy_register_definition
  * @brief emac phy register
  * @{
  */
...
#define PHY_TIMEOUT                      (0xFFFFFFFF) /*!< timeout for phy response */
...
error_status emac_init(emac_control_config_type *control_para);
...
error_status emac_loopback_mode_enable(confirm_state new_state);

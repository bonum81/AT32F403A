...
typedef enum
{
  TMR_CC_CHANNEL_MAPPED_DERECT           = 0x01, /*!< channel is configured as input, mapped derect */
  TMR_CC_CHANNEL_MAPPED_INDERECT         = 0x02, /*!< channel is configured as input, mapped inderect */
...
typedef struct
{
  ...
  tmr_input_direction_mapped_type        input_mapped_select;    /*!< tmr channel mapped derect or inderect */
  uint16_t                               input_filter_value;     /*!< tmr channel filter value */

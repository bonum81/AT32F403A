...
flag_status flash_flag_get(uint32_t flash_flag)
{
  ...
  if(flash_flag & FLASH_BANK1_OBF_FLAG)
  {
    status = (flag_status)FLASH->sts_bit.obf;
  }
  else if(flash_flag & FLASH_BANK1_ODF_FLAG)
  {
    status = (flag_status)FLASH->sts_bit.odf;
  }
  else if(flash_flag & FLASH_BANK1_PRGMERR_FLAG)
  {
    status = (flag_status)FLASH->sts_bit.prgmerr;
  }
  else if(flash_flag & FLASH_BANK1_EPPERR_FLAG)
  {
    status = (flag_status)FLASH->sts_bit.epperr;
  }
  else if(flash_flag & FLASH_USDERR_FLAG)
  {
    status = (flag_status)FLASH->usd_bit.usderr;
  }
  else if(flash_flag & FLASH_BANK2_OBF_FLAG)
  {
    status = (flag_status)FLASH->sts2_bit.obf;
  }
  else if(flash_flag & FLASH_BANK2_ODF_FLAG)
  {
    status = (flag_status)FLASH->sts2_bit.odf;
  }
  else if(flash_flag & FLASH_BANK2_PRGMERR_FLAG)
  {
    status = (flag_status)FLASH->sts2_bit.prgmerr;
  }
  else if(flash_flag & FLASH_BANK2_EPPERR_FLAG)
  {
    status = (flag_status)FLASH->sts2_bit.epperr;
  }
  else if(flash_flag & FLASH_SPIM_OBF_FLAG)
  {
    status = (flag_status)FLASH->sts3_bit.obf;
  }
  else if(flash_flag & FLASH_SPIM_ODF_FLAG)
  {
    status = (flag_status)FLASH->sts3_bit.odf;
  }
  else if(flash_flag & FLASH_SPIM_PRGMERR_FLAG)
  {
    status = (flag_status)FLASH->sts3_bit.prgmerr;
  }
  else if(flash_flag & FLASH_SPIM_EPPERR_FLAG)
  {
    status = (flag_status)FLASH->sts3_bit.epperr;
  }
...
{
  if(flash_flag & FLASH_BANK1_ODF_FLAG)
  {
    FLASH->sts_bit.odf = TRUE;
  }
  if(flash_flag & FLASH_BANK1_PRGMERR_FLAG)
  {
    FLASH->sts_bit.prgmerr = TRUE;
  }
  if(flash_flag & FLASH_BANK1_EPPERR_FLAG)
  {
    FLASH->sts_bit.epperr = TRUE;
  }
  if(flash_flag & FLASH_BANK2_ODF_FLAG)
  {
    FLASH->sts2_bit.odf = TRUE;
  }
  if(flash_flag & FLASH_BANK2_PRGMERR_FLAG)
  {
    FLASH->sts2_bit.prgmerr = TRUE;
  }
  if(flash_flag & FLASH_BANK2_EPPERR_FLAG)
  {
    FLASH->sts2_bit.epperr = TRUE;
  }
  if(flash_flag & FLASH_SPIM_ODF_FLAG)
  {
    FLASH->sts3_bit.odf = TRUE;
  }
  if(flash_flag & FLASH_SPIM_PRGMERR_FLAG)
  {
    FLASH->sts3_bit.prgmerr = TRUE;
  }
  if(flash_flag & FLASH_SPIM_EPPERR_FLAG)
  {
    FLASH->sts3_bit.epperr = TRUE;
  }
}

...
void can_flag_clear(can_type* can_x, uint32_t can_flag)
{
  switch(can_flag)
  {
    ...
    case CAN_ETR_FLAG:
      can_x->msts_bit.eoif = SET;
      can_x->ests_bit.etr = 0;
      break;
    case CAN_EOIF_FLAG:
      can_x->msts_bit.eoif = SET;
      break;
    case CAN_TM0TCF_FLAG:
      can_x->tsts_bit.tm0tcf = SET;
      break;
    case CAN_TM1TCF_FLAG:
      can_x->tsts_bit.tm1tcf = SET;
      break;
    case CAN_TM2TCF_FLAG:
      can_x->tsts_bit.tm2tcf = SET;
      break;
    case CAN_RF0FF_FLAG:
      can_x->rf0_bit.rf0mn = SET;
      break;
    case CAN_RF0OF_FLAG:
      can_x->rf0_bit.rf0mn = SET;
      break;
    case CAN_RF1FF_FLAG:
      can_x->rf1_bit.rf1ff = SET;
      break;
    case CAN_RF1OF_FLAG:
      can_x->rf1_bit.rf1of = SET;
      break;
    case CAN_QDZIF_FLAG:
      can_x->msts_bit.qdzif = SET;
      break;
    case CAN_EDZC_FLAG:
      can_x->msts_bit.edzif = SET;
      break;
    case CAN_TMEF_FLAG:
      can_x->tsts_bit.tm0tcf = SET;
      can_x->tsts_bit.tm1tcf = SET;

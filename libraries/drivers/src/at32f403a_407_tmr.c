...
void tmr_input_default_para_init(tmr_input_config_type *tmr_input_struct)
{
  ...
  tmr_input_struct->input_mapped_select = TMR_CC_CHANNEL_MAPPED_DERECT;
...
/**
  ...
  * @retval none
  */
void tmr_period_buffer_set(tmr_type *tmr_x, confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void tmr_output_channel_buffer_set(tmr_type *tmr_x, tmr_channel_select_type tmr_channel, \
                          ...
                          tmr_channel_input_divider_type divider_factor)
{
  ...
  switch(channel)
  {
    case TMR_SELECT_CHANNEL_1:
      ...
      if(input_struct->input_mapped_select == TMR_CC_CHANNEL_MAPPED_DERECT)
      {
        /* ic1 is mapped on ti1 */
        tmr_x->cm1_input_bit.c1c = TMR_CC_CHANNEL_MAPPED_DERECT;

        /* ic1 is mapped on ti2 */
        tmr_x->cm1_input_bit.c2c = TMR_CC_CHANNEL_MAPPED_INDERECT;
      }
      else if(input_struct->input_mapped_select == TMR_CC_CHANNEL_MAPPED_INDERECT)
      {
        /* ic1 is mapped on ti1 */
        tmr_x->cm1_input_bit.c1c = TMR_CC_CHANNEL_MAPPED_INDERECT;

        /* ic1 is mapped on ti2 */
        tmr_x->cm1_input_bit.c2c = TMR_CC_CHANNEL_MAPPED_DERECT;
      }
...
/**
  ...
  * @retval none
  */
void tmr_channel_buffer_select(tmr_type *tmr_x, confirm_state new_state)
{
